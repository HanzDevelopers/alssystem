    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <p class="haha">Date Encoded: 
                ...
                <?php echo isset($household_info['date_encoded']) ? htmlspecialchars($household_info['date_encoded']) : '_____________________'; ?>
                </strong></span>
            </p>
...
function confirmCancel() {
    ...
    if (result) {
        window.location.href = 'records.php'; // Redirect if user confirms
    }
}
