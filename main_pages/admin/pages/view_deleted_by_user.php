...
// Barangay-to-district mapping (retained for possible future use)
$district_mapping = [
...
// Remove district filtering for displaying all records
mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);

try {
    // Fetch all archived data, no district filter
    $query = "
        SELECT 
...
<div class="container mt-4">
    <h2 class="text-center">Archived Records</h2>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="13" class="text-center">No archived records found.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
