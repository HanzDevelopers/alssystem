...
(256, 260, 'Grade 5', 'No', 'N/A', 'Employment/Looking for work', 'Yes', 'Yes', 'Farmer', 'No'),
...
--
ALTER TABLE `background_tbl`
  MODIFY `background_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=372;

--
-- AUTO_INCREMENT for table `location_tbl`
--
ALTER TABLE `location_tbl`
  MODIFY `record_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=235;
